...
public class MilkTeaPOS {
    ...
    private void initialize() {
        ...
        panelSnacks.setBorder(new BevelBorder(BevelBorder.LOWERED));
        ...
        chckbxBurgerWithCheese = new JCheckBox("Burger w/ Cheese 70");
        chckbxBurgerWithCheese.setBounds(126, 46, 180, 23);
        panelSnacks.add(chckbxBurgerWithCheese);

        chckbxHotdog = new JCheckBox("Hotdog 60");
        chckbxHotdog.setBounds(307, 46, 120, 23);
        ...
        sankakain = new ButtonGroup();
        sankakain.add(rdbtnDineIn);
        sankakain.add(rdbtnTakeOut);
    ...
    private void createEvent() {
        btnCheckOut.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (chckbxBurgerWithCheese.isSelected()) {
